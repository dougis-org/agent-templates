...
Transition to `PLANNING` phase. Invoke `plan-ticket` sub-agent:
...
Sub-Agent Mode: analyze-ticket
Expected Output: Success summary with risk assessment, decomposition recommendation, any concerns
```
