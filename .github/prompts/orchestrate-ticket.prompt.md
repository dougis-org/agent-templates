...
- **State Schema:** `.github/prompts/includes/state-schema.md`
- **Phase Transitions:** `.github/prompts/includes/phase-transitions.md`
- **Quality Gates:** `.github/prompts/includes/quality-gates.md`
- **Segment Handoff:** `.github/prompts/includes/segment-handoff.md`
- **Orchestration Rules:** `.github/instructions/orchestration-rules.instructions.md`
...
**Dispatch to:** `.github/prompts/segment-1-plan.prompt.md`
...
**Dispatch to:** `.github/prompts/gate-1-plan-review.prompt.md`
...
**Dispatch to:** `.github/prompts/segment-2-implement.prompt.md`
...
**Dispatch to:** `.github/prompts/gate-2-pr-review.prompt.md`
...
**Dispatch to:** `.github/prompts/segment-3-finalize.prompt.md`
