...
- [Ticket Flow: End-to-End Workflow Guide](#ticket-flow-end-to-end-workflow-guide)
  - [Overview](#overview)
    - [Automated Workflow Execution](#automated-workflow-execution)
  - [Table of Contents](#table-of-contents)
  - [Phase 1: Discovery \& Selection](#phase-1-discovery--selection)
  ...
  - [Phase 3: Analysis \& Understanding](#phase-3-analysis--understanding)
  ...
  - [Phase 5: Review \& Submission](#phase-5-review--submission)
    - [Step 5.1: Review Ticket Work (Optional)](#step-51-review-ticket-work-optional)
  ...
  - [Scenario-Based Flows](#scenario-based-flows)
    - [Scenario A: Happy Path (Start to Finish)](#scenario-a-happy-path-start-to-finish)
