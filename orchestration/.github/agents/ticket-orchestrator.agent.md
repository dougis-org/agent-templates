...
- Refer to `orchestration/.github/prompts/includes/state-schema.md` for structure
...
- Refer to `orchestration/.github/prompts/includes/quality-gates.md` for per-phase gates
...
- Refer to `orchestration/.github/prompts/includes/phase-transitions.md` for routing table
